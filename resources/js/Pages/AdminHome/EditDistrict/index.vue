        ...
        <form @submit.prevent="add">
            <div class="min-h-screen flex flex-col gap-10 items-center">
                ...
                <div class="max-w-2xl w-full mx-auto bg-gray-50 rounded-lg p-7 space-y-7">
                    ...
                    <div>
                        <button
                            class="w-full bg-gray-300 py-2 text-center rounded-lg hover:bg-gray-400 hover:text-white">Add</button>
                    </div>
                </div>
                <div class="border">
                    <table class="w-96 text-justify">
                        ...
                        <tbody>
                            <tr v-for="edit_district in edit_districts">
                                <td class="p-2 border text-center">{{ edit_district.id }}</td>
                                <td class="text-center border">{{ edit_district.district }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
