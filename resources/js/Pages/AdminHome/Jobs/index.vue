                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="whitespace-nowrap px-6 py-4">
                                    ...
                                    >
                                        <button
                                            class="hover:bg-gray-300 p-2 rounded-lg"
                                        >
                                            Applicant list
                                        </button>
                                    </Link>
                                ...
                                <td class="whitespace-nowrap px-6 py-4">
                                    <Link
                                        :href="
                                            route('admin.jobs.show', addjob.id)
                                        "
                                    >
                                        <button
                                            class="hover:bg-gray-300 my-3 p-2 rounded-lg"
                                        >
                                            Job details
                                        </button>
                                    </Link>
                                ...
                                <td class="whitespace-nowrap px-6 py-4">
                                    <Link
                                        :href="
                                            route('admin.jobs.edit', addjob.id)
                                        "
                                    >
                                        <svg
            ...
            <tbody>
                ...
                >
                    ...
                    <td>
                        <Link
                            :href="
                                route('admin.applicant-list.show', addjob.id)
                            "
                        >
