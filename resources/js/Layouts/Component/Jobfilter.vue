<template>
    <form @submit.prevent="filter">
        <!-- <div class="m-3 flex bg-green-300"> -->
        <div class="m-3 mt-2 md:flex gap-2 justify-start mr-3">
            ...
            <div class="xl:flex items-center gap-1 lg:grid grid-rows-1 md:gap-2 w-full xl:w-auto md:w-auto">
                ...
                <input v-model="filterForm.job_title" type="text" placeholder="Job title"
                    class="border border-gray-300 rounded-lg mb-2 lg:border-gray-300 text-sm md:border-gray-300 sm:border-gray-300 sm:mb-2" />
                <input v-model="filterForm.department" type="text" placeholder="Department"
                    class="border border-gray-300 rounded-lg mb-2 lg:border-gray-300 text-sm md:border-gray-300 sm:border-gray-300 sm:mb-2" />
            </div>
            <div class="md:flex md:gap-2 flex gap-2">
                <button type="submit"
